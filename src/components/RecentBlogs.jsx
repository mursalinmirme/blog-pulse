...
const RecentBlogs = () => {
    ...
    return (
        <div className="max-w-screen-2xl mx-auto">
            ...
            <h3 className="text-center font-bold text-2xl lg:text-3xl font-fontNoto text-[#344E41]">Recent Blog Features</h3>
            <p className="md:w-2/3 px-8 md:px-0 text-center mx-auto text-sm mt-4 leading-relaxed text-[#588157]">Explore our most recent blog posts to stay in the loop with the latest trends, insights, and stories.</p>
