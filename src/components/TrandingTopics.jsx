...
const TrandingTopics = () => {
  ...
  return (
    <motion.div
      className="mt-20 w-11/12 lg:w-10/12 mx-auto"
    ...
    >
      ...
      <p className="text-sm mt-3 w-11/12 md:w-9/12 lg:w-1/2 mx-auto px-5 leading-relaxed text-center">
        Dive into the latest trends and hot discussions in the blogosphere with
        ...
        <Slider {...settings}>
          ...
          <div className="p-2 lg:px-4">
            ...
            <div className="border p-5 rounded-md">
              ...
              <h3 className="text-2xl font-semibold mt-3 text-[#3A5A40]">
                Topic: Sustainable Travel
              </h3>
              <p className="text-lg mt-1">
                Explore eco-friendly travel options and destinations that
          ...
          <div className="p-2 lg:px-4">
            ...
            <div className="border p-5 rounded-md">
              ...
              <p className="text-lg mt-1 hidden md:block">
                Uncover the latest news and insights into the world of
                cryptocurrencies and blockchain technology...
              </p>
              <p className="text-lg mt-1 md:hidden">
                Uncover the latest news and insights into the world of crypto
          ...
          <div className="p-2 lg:px-4">
            ...
            <div className="border p-5 rounded-md">
              ...
              <p className="text-lg mt-1">
                Explore the latest discoveries and missions related to Mars
          ...
          <div className="p-2 lg:px-4">
            ...
            <div className="border p-5 rounded-md">
              ...
              <p className="text-lg mt-1">
                Join in the celebrations of cultural heritage and traditions
